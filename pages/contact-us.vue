      ...
      <div class="flex flex-wrap flex-col w-full items-center justify-center">
        ...
        >
          ...
          >
            ...
            <p class="info-content">+39 02 2399 1</p>
            ...
            <p class="info-content">winter.school@polimi.it</p>
            ...
            <p class="info-content">winter.2024@polimi.it</p>
            ...
            <p class="info-content">400€ per Week</p>
          </div>
        </div>
      </div>
    </div>
